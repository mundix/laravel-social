...
class CompanyAdminStorySponsorsModalComponent extends Component
{
    ...
    protected $listeners = [
        'CompanyAdminStorySponsorsModalComponent' => 'setSponsors'
    ];

    public function render()
    {
        $employees = (new CompanyService)->getActiveEmployeesByCompany($this->company, $this->searchQuery);
        return view('livewire.companies.admin.stories.company-admin-story-sponsors-modal-component', [
            'employees' => $employees ,
