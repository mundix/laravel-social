...
namespace App\Http\Livewire\Companies\Admin\Profile;
...
class CompanyAdminProfilePictureComponent extends Component
{
    ...
    {
        return view('livewire.companies.admin.profile.company-admin-profile-picture-component');
    }
